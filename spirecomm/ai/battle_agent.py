...
class BattleAgent:
    ...
    def llm_1(self, state: State):
        ...
        system_msg = f"""
                            ...
                            Based on the context, please finish this operation by combining overall guidance,user guidance
                            ...
                            [ {{ turn: int, operation: str, thoughts: str }}, ...  ]
    ...
    def invoke(self, floor: int, turn: int,
        ...
        round_info = f"{{ turn:{turn},operation:{operation},thoughts:{self.explanation} }}"
